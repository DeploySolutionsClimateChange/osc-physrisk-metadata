...
CREATE TABLE osc_physrisk_backend.user (
	...
	core_datetime_utc_last_modified timestamptz DEFAULT NULL,
	core_last_modifier_user_id BIGINT DEFAULT NULL,
...
CREATE TABLE osc_physrisk_backend.data_set ( 
	...
	core_name_full VARCHAR(255) NOT NULL,
	core_name_short VARCHAR(255),
	...
	core_publish_is_published BOOLEAN DEFAULT 'n',
	core_publish_publisher_id BIGINT DEFAULT NULL,
	core_publish_datetime_utc TIMESTAMPTZ DEFAULT NULL,
	core_version TEXT DEFAULT '1.0',
	core_dataset_id uuid,
	data_contact TEXT, -- Contact information for inquiries about the dataset.
	data_quality TEXT, -- Information on the accuracy, completeness, and source of the data.
	data_format TEXT NOT NULL, -- Formats in which the data is available.
	data_schema TEXT, -- Describe the data schema, or reference the Json Schema or Frictionless CSV schema. Can be a hyperlink to a relevant schema file.
	...
	data_usage_notes TEXT, -- Notes on how the dataset can be used.
	data_related TEXT, -- Links to related datasets for further information or analysis. Could be a list of UUIDs or a textual description, or hyperlinks
...
ALTER TABLE osc_physrisk_backend.data_set
	ADD FOREIGN KEY (core_dataset_id) 
	REFERENCES osc_physrisk_backend.data_set (core_id);
...
CREATE TABLE osc_physrisk_backend.geo_country ( 
	...
	CONSTRAINT fk_geo_country_core_deleter_user_id FOREIGN KEY ( core_deleter_user_id ) REFERENCES osc_physrisk_backend.user(core_id),
 	CONSTRAINT fk_geo_country_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id)
	); 
...
CREATE TABLE osc_physrisk_scenarios.scenario ( 
	...
	core_dataset_id UUID,
	CONSTRAINT pk_scenario PRIMARY KEY ( core_id ),
	CONSTRAINT fk_scenario_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
	CONSTRAINT fk_scenario_core_creator_user_id FOREIGN KEY ( core_creator_user_id ) REFERENCES osc_physrisk_backend.user(core_id),
	CONSTRAINT fk_scenario_core_last_modifier_user_id FOREIGN KEY ( core_last_modifier_user_id ) REFERENCES osc_physrisk_backend.user(core_id),
	CONSTRAINT fk_scenario_core_deleter_user_id FOREIGN KEY ( core_deleter_user_id ) REFERENCES osc_physrisk_backend.user(core_id)
 ); 
...
CREATE TABLE osc_physrisk_scenarios.hazard ( 
	...
	CONSTRAINT fk_hazard_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_scenarios.hazard_indicator ( 
	...
	CONSTRAINT fk_hazard_indicator_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_assets.asset_class ( 
	...
	CONSTRAINT fk_asset_class_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_assets.asset_type ( 
	...
	CONSTRAINT fk_asset_type_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_assets.portfolio ( 
	...
	CONSTRAINT fk_portfolio_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_assets.generic_asset ( 
	...
	CONSTRAINT fk_generic_asset_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_assets.asset_realestate ( 
	...
	CONSTRAINT fk_asset_realestate_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_assets.asset_powergeneratingutility ( 
	...
	CONSTRAINT fk_asset_powergeneratingutility_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_vulnerability_analysis.exposure_function ( 
	...
	CONSTRAINT fk_exposure_function_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_vulnerability_analysis.vulnerability_function ( 
	...
	CONSTRAINT fk_vulnerability_function_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_vulnerability_analysis.vulnerability_type ( 
	...
	CONSTRAINT fk_vulnerability_type_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_vulnerability_analysis.hazard_data_request ( 
	...
	CONSTRAINT fk_hazard_data_request_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_vulnerability_analysis.portfolio_vulnerability ( 
	...
	CONSTRAINT fk_portfolio_vulnerability_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_vulnerability_analysis.asset_vulnerability ( 
	...
	CONSTRAINT fk_asset_vulnerability_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_vulnerability_analysis.geolocated_precalculated_vulnerability ( 
	...
	CONSTRAINT fk_geolocated_precalculated_vulnerability_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_financial_analysis.financial_function ( 
	...
	CONSTRAINT fk_financial_function_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_financial_analysis.financial_impact_type ( 
	...
	CONSTRAINT fk_financial_impact_type_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_financial_analysis.portfolio_financial_impact ( 
	...
	CONSTRAINT fk_portfolio_financial_impact_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
...
CREATE TABLE osc_physrisk_financial_analysis.asset_financial_impact ( 
	...
	CONSTRAINT fk_asset_financial_impact_core_dataset_id FOREIGN KEY ( core_dataset_id ) REFERENCES osc_physrisk_backend.data_set(core_id),
